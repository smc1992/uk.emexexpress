...
$subjectPrefix = '[UK Airfreight Inquiry]';
...
<head>
    <meta charset='UTF-8'>
    <title>UK Airfreight Inquiry</title>
    <style>
...
<body>
    <div class='header'>
        <h1>🚁 NEW AIRFREIGHT BOOKING INQUIRY - UK</h1>
        <p>Submitted: " . date('Y-m-d H:i:s') . "</p>
        <p>Source: UK Landing Page</p>
    </div>
...
$htmlMessage .= "
    ...
    <div class='footer'>
        <p>This inquiry was submitted via the UK Airfreight Landing Page</p>
...
$textMessage = "NEW AIRFREIGHT BOOKING INQUIRY - UK\n";
$textMessage .= "========================================\n\n";
$textMessage .= "Submitted: " . date('Y-m-d H:i:s') . "\n";
$textMessage .= "Source: UK Landing Page\n\n";
...
try {
    ...
    if (mail($adminEmail, $subject, $htmlMessage, implode("\r\n", $headers))) {
        ...
        echo json_encode([
            ...
            'booking_id' => 'UK' . date('YmdHis') . strtoupper(substr(md5(uniqid()), 0, 6))
        ]);
    } else {
