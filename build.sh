...
# UK Airfreight Landing Page Docker Build Script
...
IMAGE_NAME="uk-airfreight-landing"
VERSION=${1:-latest}

echo "🇬🇧 Building UK Airfreight Landing Page Docker Image"
...
echo ""
echo "🎯 UK Docker image ready for Coolify deployment!"
echo "📍 Image: $DOCKER_REGISTRY/$IMAGE_NAME:$VERSION"
echo "🌐 Domain: uk.emexexpress.de"
echo ""
